...
public class WebApplicationBoostrap
{
    ...
    private Action<FluentValidationAutoValidationConfiguration>? _configureFluentValidation;
    ...
    public WebApplicationBoostrap ConfigureFluentValidation(Action<FluentValidationAutoValidationConfiguration> configureFluentValidation)
    {
